            ...
            <div class="mx-auto max-w-3xl">
                ...
                <div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row animate-fade-in-up anim-delay-3">
                    @if(Route::has('register'))
                        <a href="{{ route('register') }}" class="arrow-slide group w-full rounded-xl bg-purple-600 px-8 py-3.5 text-center font-semibold text-white shadow-lg shadow-purple-500/25 transition-all hover:bg-purple-700 hover:shadow-xl hover:shadow-purple-500/30 sm:w-auto flex items-center justify-center gap-2">
                            {{ __('Get Started Free') }}
            ...
            <div class="overflow-hidden rounded-3xl bg-gradient-to-br from-purple-600 via-purple-700 to-blue-600 p-10 text-center text-white sm:p-16 relative">
                ...
                <div class="relative">
                    ...
                    <div class="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                        @if(Route::has('register'))
                            <a href="{{ route('register') }}" class="arrow-slide group w-full rounded-xl bg-white px-8 py-3.5 font-semibold text-purple-700 shadow-lg transition-all hover:bg-purple-50 hover:shadow-xl sm:w-auto flex items-center justify-center gap-2">
                                {{ __('Get Started Free') }}
                                <svg class="arrow-icon size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" /></svg>
                            </a>
                        @endif
