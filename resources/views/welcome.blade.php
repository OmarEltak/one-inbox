                ...
                <div class="flex gap-5 pb-4 pt-6" style="width: max-content;">
                    ...
                    $plans = [
                        [
                            ...
                            'price'   => '$0',
                            'period'  => __('forever'),
                            'desc'    => __('Try it with no commitment.'),
                            'popular' => false,
                            'features' => [
                                __('1 connected page'),
                                __('20 AI replies / month'),
                                __('Unified inbox'),
                                __('1 team member'),
                            ],
                            'cta'     => __('Start for free'),
                            'href'    => route('register'),
                            'outline' => true,
                        ],
                        [
                            ...
                            'price'   => '$8',
                            'period'  => __('/ mo'),
                            'desc'    => __('Just enough AI to get started.'),
                            'popular' => false,
                            'features' => [
                                __('1 connected page'),
                                __('100 AI replies / month'),
                                __('Unified inbox'),
                                __('1 team member'),
                            ],
                            'cta'     => __('Get Basic'),
                        ...
                        [
                            ...
                            'price'   => '$29',
                            'period'  => __('/ mo'),
                            'desc'    => __('Your AI sales rep, 24/7.'),
                            'popular' => false,
                            'features' => [
                                __('3 connected pages'),
                                __('500 AI replies / month'),
                                __('All 4 platforms'),
                                __('Lead scoring'),
                                __('3 team members'),
                            ],
                        ...
                        [
                            ...
                            'price'   => '$79',
                            'period'  => __('/ mo'),
                            'desc'    => __('Built for teams that close deals.'),
                            'popular' => true,
                            'features' => [
                                __('5 connected pages'),
                                __('2,000 AI replies / month'),
                        ...
                        [
                            ...
                            'price'   => __('Custom'),
                            'period'  => '',
                            'desc'    => __('For agencies & large teams.'),
                            'popular' => false,
                            'features' => [
                                __('Unlimited pages'),
                                __('Unlimited AI replies'),
                                __('All platforms'),
