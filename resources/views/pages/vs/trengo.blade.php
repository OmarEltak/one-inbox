...
>
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-line bg-ink text-cream">
                            ...
                            <th class="serif px-6 py-4 text-center text-xl font-normal text-cream/70">Trengo</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php
    ...
    <section class="py-24 lg:py-28">
        <div class="mx-auto max-w-6xl px-6">
            <div class="mx-auto max-w-2xl text-center">
                ...
                <p class="mt-4 leading-relaxed text-ink/70">{{ __('Three areas where OT1-Pro leaves Trengo behind.') }}</p>
            </div>
    ...
    <section class="border-y border-line bg-cream2 py-24">
        <div class="mx-auto max-w-3xl px-6">
            <div class="text-center">
                <h2 class="serif text-4xl leading-tight text-ink lg:text-5xl">{{ __('Common questions about switching from Trengo') }}</h2>
            </div>
    ...
    <section class="bg-ink text-cream py-24 grain relative overflow-hidden">
        <div class="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <p class="text-cream/70 text-lg mb-8 max-w-xl mx-auto">{{ __('Join businesses that switched from Trengo and now close more deals with less manual effort.') }}</p>
