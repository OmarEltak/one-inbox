    ...
    <section class="py-20 lg:py-28">
        <div class="mx-auto max-w-4xl px-6">
            <div class="rounded-3xl bg-gradient-to-br from-indigo-600 to-violet-600 p-10 text-center text-white sm:p-16">
                ...
                <p class="mx-auto mt-4 max-w-xl text-lg text-indigo-100">{{ __('Join social-first businesses that switched from Tidio to close more deals on WhatsApp and Instagram with AI.') }}</p>
