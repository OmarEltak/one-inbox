<x-layouts.marketing :title="__('Terms of Service') . ' — OT1-Pro'" :description="__('OT1-Pro Terms of Service — the rules and guidelines for using our platform.')">
        ...
        <div class="mx-auto max-w-3xl px-6">
            ...
            <div class="mt-12 space-y-10 text-zinc-600 dark:text-zinc-600">
                ...
                <div>
                    ...
                    <p class="mt-3">{{ __('By accessing or using OT1-Pro ("Service", "Platform"), you ("User", "Customer") agree to be bound by these Terms of Service ("Terms") and our Privacy Policy. If you are using OT1-Pro on behalf of a business, you represent that you have the authority to bind that business to these Terms.') }}</p>
                ...
                <div>
                    ...
                    <p class="mt-3">{{ __('OT1-Pro provides a unified social media inbox for businesses, enabling them to:') }}</p>
                ...
                <div>
                    ...
                    <p class="mt-3">{{ __('You must create an account to use OT1-Pro. You agree to:') }}</p>
                    <ul class="mt-2 list-disc pl-5 space-y-1 text-sm">
                ...
                <div>
                    ...
                    <p class="mt-3">{{ __('When you connect social media accounts to OT1-Pro, you agree to comply with the terms and policies of each respective platform:') }}</p>
                    ...
                    <p class="mt-3">{{ __('You are solely responsible for ensuring your use of connected platforms complies with their respective terms. OT1-Pro is not responsible for any actions taken by platforms against your accounts.') }}</p>
                </div>

                <div>
                    <h2 class="text-xl font-semibold text-zinc-900 dark:text-zinc-100">{{ __('5. Acceptable Use') }}</h2>
                    <p class="mt-3">{{ __('You agree NOT to use OT1-Pro to:') }}</p>
                    <ul class="mt-2 list-disc pl-5 space-y-1 text-sm">
                ...
                <div>
                    ...
                    <p class="mt-3">{{ __('OT1-Pro provides AI-powered reply suggestions and auto-response features powered by third-party AI providers. You acknowledge that:') }}</p>
                    <ul class="mt-2 list-disc pl-5 space-y-2 text-sm">
                        ...
                        <li>{{ __('OT1-Pro is not liable for any consequences resulting from AI-generated messages') }}</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-3">{{ __('OT1-Pro and its original content, features, and functionality are owned by OT1-Pro and protected by international copyright, trademark, and other intellectual property laws.') }}</p>
                    <p class="mt-3">{{ __('You retain ownership of all content you create and messages you manage through OT1-Pro. By using our Service, you grant us a limited license to process and display your content solely for the purpose of providing the Service.') }}</p>
                </div>

                <div>
                    <h2 class="text-xl font-semibold text-zinc-900 dark:text-zinc-100">{{ __('9. Data & Privacy') }}</h2>
                    <p class="mt-3">{{ __('Your use of OT1-Pro is also governed by our Privacy Policy, which is incorporated into these Terms by reference. We process your data as described therein and in compliance with applicable data protection laws.') }}</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-3">{{ __('To the maximum extent permitted by law, OT1-Pro and its affiliates, officers, employees, and agents shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or goodwill, arising from your use of the Service.') }}</p>
                ...
                <div>
                    ...
                    <p class="mt-3">{{ __('You agree to indemnify and hold harmless OT1-Pro from any claims, damages, losses, and expenses (including legal fees) arising from your use of the Service, your violation of these Terms, or your violation of any third-party rights including connected platform terms.') }}</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-3">{{ __('We reserve the right to modify these Terms at any time. We will provide at least 30 days notice of material changes via email or in-app notification. Continued use of OT1-Pro after the effective date of changes constitutes acceptance.') }}</p>
                </div>
