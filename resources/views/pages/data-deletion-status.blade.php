<x-layouts.marketing
    ...
    <section class="py-20 lg:py-28">
        <div class="mx-auto max-w-2xl px-6">
            ...
            <p class="mt-3 text-zinc-600 dark:text-zinc-600">{{ __('This page shows the current status of a data deletion request submitted on your behalf by Meta.') }}</p>

            <dl class="mt-10 divide-y divide-zinc-200 rounded-2xl border border-zinc-200 bg-zinc-50 dark:divide-zinc-800 dark:border-zinc-200 dark:bg-white">
            ...
            <div class="mt-10 rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-200 dark:bg-white">
                <h2 class="font-semibold">{{ __('What was deleted') }}</h2>
                <p class="mt-3 text-sm text-zinc-600 dark:text-zinc-600">
