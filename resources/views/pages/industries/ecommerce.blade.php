...
@endpush
    ...
    <section class="py-20">
        <div class="mx-auto max-w-6xl px-6">
            <div class="text-center">
                <h2 class="text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl">{{ __('What the AI Handles for Your Store') }}</h2>
    ...
    <section class="bg-zinc-50 py-20 dark:bg-zinc-50">
        <div class="mx-auto max-w-6xl px-6">
            <div class="text-center">
                <h2 class="text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl">{{ __('All Your Sales Channels. OT1-Pro.') }}</h2>
    ...
    <section class="border-t border-zinc-200 bg-zinc-50 py-20 lg:py-28">
        <div class="mx-auto max-w-3xl px-6 text-center">
            <h2 class="text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl">{{ __('Turn Social Messages Into Sales') }}</h2>
            <p class="mx-auto mt-5 max-w-xl text-lg text-zinc-600">{{ __('One inbox for all your channels, AI that works 24/7. Free to start.') }}</p>
