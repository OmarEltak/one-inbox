...
@endpush
        ...
        <div class="mx-auto max-w-6xl px-6">
            ...
            <div class="mt-16 grid gap-6 lg:grid-cols-4">
                ...
                <div class="rounded-2xl border border-zinc-200 bg-white p-8 dark:border-zinc-200 dark:bg-white flex flex-col">
                    ...
                    <div class="mt-auto pt-8">
                        <a href="https://wa.me/201026361218?text={{ urlencode('Hi, I\'m interested in the Starter plan ($29/mo)') }}" target="_blank" class="block w-full rounded-lg border border-indigo-300 py-2.5 text-center text-sm font-semibold text-indigo-700 transition-colors hover:bg-indigo-50 dark:border-indigo-700 dark:text-indigo-700 dark:hover:bg-indigo-900/20">
                            {{ __('Get Started') }}
                        </a>
                    </div>
                </div>
                ...
                <div class="relative rounded-2xl border-2 border-indigo-600 bg-white p-8 dark:bg-white flex flex-col">
                    ...
                    <div class="mt-auto pt-8">
                        <a href="https://wa.me/201026361218?text={{ urlencode('Hi, I\'m interested in the Pro plan ($79/mo)') }}" target="_blank" class="block w-full rounded-lg bg-indigo-600 py-2.5 text-center text-sm font-semibold text-white transition-colors hover:bg-indigo-700">
                            {{ __('Get Started') }}
                        </a>
                    </div>
                </div>
    ...
    <section class="bg-indigo-600 py-20">
        <div class="mx-auto max-w-3xl px-6 text-center">
            ...
            <a href="https://wa.me/201026361218" target="_blank" class="mt-8 inline-flex items-center gap-2 rounded-lg bg-white px-8 py-3 text-sm font-semibold text-indigo-700 transition-colors hover:bg-indigo-50">
