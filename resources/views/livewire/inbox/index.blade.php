...
>
    ...
    {{-- Message Thread --}}
    <div class="flex-1 flex flex-col min-w-0 min-h-0 h-full {{ $selectedConversationId ? 'flex' : 'hidden md:flex' }}">
        @if($this->selectedConversation)
            ...
            {{-- Messages --}}
            <div class="flex-1 min-h-0 overflow-y-auto p-4 space-y-3 flex flex-col" id="message-thread"
                 x-data="{
                     isNearBottom: true,
