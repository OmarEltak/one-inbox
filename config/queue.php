    ...
    */
    ...
    'connections' => [
        ...
        'database' => [
            ...
            // MUST be > the longest per-job $timeout. Longest today is
            // ScoreLeadJob (300s), so we sit at 600s = 2× max. If a job legitimately
            // runs longer than retry_after, the driver assumes it died and hands the
            // same job to a second worker → duplicate send / duplicate webhook.
